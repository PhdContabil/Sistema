...
function LinhaEmpresa({
  e, aj, base, calc, anos, colunas, salvando, aberta, onAbrir, onSalvar, onLimpar,
}: {
  e: PerfilEmpresa;
  aj: Ajuste | undefined;
  base: number | null;
    ...
    <>
      <tr className={aj ? "tem-ajuste" : ""}>
        <td className="col-empresa">
          ...
          <button className="btn-detalhes" onClick={onAbrir} aria-expanded={aberta}>
            ...
            <div className="detail-box">
              ...
              <div className="det-grid">
                <label className="campo-inline larga">
                  ...
                  <textarea
                    rows={2} value={obs} disabled={salvando}
                  ...
                  {aj ? (
                    <>
                      ...
                      <div className="detail-note">
                        {aj.valor_base !== null && <>De R$ {formatBRL(aj.valor_base)} </>}
                        para <strong>R$ {formatBRL(calc.valorNovo)}</strong>
                        {calc.percentual !== null && <> ({formatPct(calc.percentual)})</>}
                      </div>
                    ...
                    <div className="detail-note">
                      Segue o percentual geral. Preencha % ou valor na linha para criar uma exceção.
                    </div>
                  )}
                </div>
              </div>
              <div className="detail-note" style={{ marginTop: 10 }}>
                ...
                {buscandoServicos && " — carregando…"}
                {servicos !== null && servicos.length === 0 && " — nenhum serviço vigente."}
