...
export const MODULES: ModuleDef[] = [
  ...
  },
  {
    ...
    apps: [
      ...
      { name: "Roda da Vida", desc: "Retrato pessoal em 9 dimensões e um plano de pequenas ações.", href: "/m/pessoas/roda-vida" },
  ...
  },
  {
    ...
    apps: [
      ...
      { name: "Inventário de TI", desc: "Equipamentos, licenças e a quem estão alocados.", href: "/m/tecnologia/inventario" },
