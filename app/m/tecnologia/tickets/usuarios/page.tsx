...
export default async function Page() {
  ...
  return (
    <Workspace moduleId="tecnologia" appName="Tickets · Usuários">
      <TicketsShell resumo={resumo} souAdmin={souAdmin} souAdminGeral={souAdminGeral} meuSetor={meuSetor}>
        <div className="mb-4">
          ...
          <div className="text-sm text-slate-500 dark:text-slate-400 mt-1">Pessoas que podem ser atribuídas a tickets, por setor.</div>
        </div>
        {!souAdmin ? (
